export default {
    ...
    specialistsDescr:     "Ваша емоційна стабільність - наша головна мета. Тому в нашій команді працюють лише фахівці з сертифікацією та досвідом роботи, яких відібрали наші провідні спеціалісти. Ми гарантуємо професіоналізм психологів суворим відбором.",
